...
def fun_8x8_pq():
    #pq
    print("\npq:")
    f1 = open(".././result/pq/pq_fpga_coeff/pq_fpga_8x8.txt","r")
    f2 = open(".././result/pq/pq_hpm_coeff/pq_hpm_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
        print("pq 8x8 : Right!")
...
def fun_8x8_ocd():
    #ocd
    print("\nocd:")
    f1 = open(".././result/ocd/fpga_prevel/fpga_prevel_8x8.txt","r")
    f2 = open(".././result/ocd/hpm_prevel/hpm_prevel_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/ocd/fpga_run/fpga_run_8x8.txt","r")
    f2 = open(".././result/ocd/hpm_run/hpm_run_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
        print("run 8x8 : Right!")
    ...
    f1 = open(".././result/ocd/fpga_level_opt/fpga_level_opt_8x8.txt","r")
    f2 = open(".././result/ocd/hpm_level_opt/hpm_level_opt_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/ocd/fpga_uncoded_cost/fpga_uncoded_cost_8x8.txt","r")
    f2 = open(".././result/ocd/hpm_uncoded_cost/hpm_uncoded_cost_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/ocd/fpga_coded_cost/fpga_coded_cost_8x8.txt","r")
    f2 = open(".././result/ocd/hpm_coded_cost/hpm_coded_cost_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/ocd/fpga_base_cost_buffer/fpga_base_cost_buffer_8x8.txt","r")
    f2 = open(".././result/ocd/hpm_base_cost_buffer/hpm_base_cost_buffer_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
...
def fun_8x8_lnpd():
    #lnpd
    print("\nlnpd:")
    f1 = open(".././result/lnpd/fpga_rdoq_last_x/fpga_rdoq_last_x_8x8.txt","r")
    f2 = open(".././result/lnpd/hpm_rdoq_last_x/hpm_rdoq_last_x_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/lnpd/fpga_rdoq_last_y/fpga_rdoq_last_y_8x8.txt","r")
    f2 = open(".././result/lnpd/hpm_rdoq_last_y/hpm_rdoq_last_y_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/lnpd/fpga_endPosCost/fpga_endPosCost_8x8.txt","r")
    f2 = open(".././result/lnpd/hpm_endPosCost/hpm_endPosCost_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/lnpd/fpga_rdoqD64LastOne/fpga_rdoqD64LastOne_8x8.txt","r")
    f2 = open(".././result/lnpd/hpm_rdoqD64LastOne/hpm_rdoqD64LastOne_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/lnpd/fpga_rdoqD64LastZero/fpga_rdoqD64LastZero_8x8.txt","r")
    f2 = open(".././result/lnpd/hpm_rdoqD64LastZero/hpm_rdoqD64LastZero_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/lnpd/fpga_tempCost/fpga_tempCost_8x8.txt","r")
    f2 = open(".././result/lnpd/hpm_tempCost/hpm_tempCost_8x8.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
...
def fun_4x4_pq():
    #pq
    print("\npq:")
    f1 = open(".././result/pq/pq_fpga_coeff/pq_fpga_4x4.txt","r")
    f2 = open(".././result/pq/pq_hpm_coeff/pq_hpm_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
        print("pq 4x4 : Right!")
...
def fun_4x4_ocd():    
    #ocd
    print("\nocd:")
    f1 = open(".././result/ocd/fpga_prevel/fpga_prevel_4x4.txt","r")
    f2 = open(".././result/ocd/hpm_prevel/hpm_prevel_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/ocd/fpga_run/fpga_run_4x4.txt","r")
    f2 = open(".././result/ocd/hpm_run/hpm_run_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
        print("run 4x4 : Right!")
    ...
    f1 = open(".././result/ocd/fpga_level_opt/fpga_level_opt_4x4.txt","r")
    f2 = open(".././result/ocd/hpm_level_opt/hpm_level_opt_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/ocd/fpga_uncoded_cost/fpga_uncoded_cost_4x4.txt","r")
    f2 = open(".././result/ocd/hpm_uncoded_cost/hpm_uncoded_cost_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/ocd/fpga_coded_cost/fpga_coded_cost_4x4.txt","r")
    f2 = open(".././result/ocd/hpm_coded_cost/hpm_coded_cost_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/ocd/fpga_base_cost_buffer/fpga_base_cost_buffer_4x4.txt","r")
    f2 = open(".././result/ocd/hpm_base_cost_buffer/hpm_base_cost_buffer_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
...
def fun_4x4_lnpd():   
    #lnpd
    print("\nlnpd:")
    f1 = open(".././result/lnpd/fpga_rdoq_last_x/fpga_rdoq_last_x_4x4.txt","r")
    f2 = open(".././result/lnpd/hpm_rdoq_last_x/hpm_rdoq_last_x_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/lnpd/fpga_rdoq_last_y/fpga_rdoq_last_y_4x4.txt","r")
    f2 = open(".././result/lnpd/hpm_rdoq_last_y/hpm_rdoq_last_y_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/lnpd/fpga_endPosCost/fpga_endPosCost_4x4.txt","r")
    f2 = open(".././result/lnpd/hpm_endPosCost/hpm_endPosCost_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/lnpd/fpga_rdoqD64LastOne/fpga_rdoqD64LastOne_4x4.txt","r")
    f2 = open(".././result/lnpd/hpm_rdoqD64LastOne/hpm_rdoqD64LastOne_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/lnpd/fpga_rdoqD64LastZero/fpga_rdoqD64LastZero_4x4.txt","r")
    f2 = open(".././result/lnpd/hpm_rdoqD64LastZero/hpm_rdoqD64LastZero_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
    ...
    f1 = open(".././result/lnpd/fpga_tempCost/fpga_tempCost_4x4.txt","r")
    f2 = open(".././result/lnpd/hpm_tempCost/hpm_tempCost_4x4.txt","r")
    txt1 = f1.read()
    txt2 = f2.read()
    if txt1 == txt2:
